...
import { Day1, Day10, Day11, Day12, Day13, Day2, Day3, Day4, Day5, Day6, Day7, Day8, Day9 } from "./solutions";
...
let dayClasses = [Day1, Day2, Day3, Day4, Day5, Day6, Day7, Day8, Day9, Day10, Day11, Day12, Day13];
let days : IDay[] = [ ];
